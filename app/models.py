...
class Genre(models.Model):
    name = models.CharField(
        max_length=NAME_MAX_LENGTH, unique=True, verbose_name="Жанр"
    )
...
class Director(models.Model):
    name = models.CharField(
        max_length=NAME_MAX_LENGTH, unique=True, verbose_name="Режиссёр"
    )
...
class Country(models.Model):
    name = models.CharField(
        max_length=NAME_MAX_LENGTH, unique=True, verbose_name="Страна"
    )
...
class Movie(models.Model):
    ...
    poster_link = models.TextField(
        blank=True, null=True, verbose_name="Ссылка на постер"
    )
    local_poster = models.ImageField(
        upload_to=POSTER_UPLOAD_PATH,
        blank=True,
        null=True,
        verbose_name="Локальная ссылка на постер",
    )
    ...
    runtime = models.TextField(
        ...
        help_text='Формат: "<число> минут(ы)"',
    )
...
class MovieRating(models.Model):
    ...
    user_rating = models.PositiveIntegerField(
        blank=True, null=True, choices=MOVIE_RATING_CHOICES
    )
    added_at = models.DateTimeField(auto_now_add=True)
